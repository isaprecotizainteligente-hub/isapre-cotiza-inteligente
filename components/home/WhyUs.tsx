...
export default function WhyUs() {
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 top-0 -z-10 h-96 w-96 -translate-x-1/2 rounded-full bg-blue-600/10 blur-[140px]" />
          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute right-0 top-0 h-28 w-28 rounded-full bg-blue-500/10 blur-3xl transition group-hover:scale-125" />
