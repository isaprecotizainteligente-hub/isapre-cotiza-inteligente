...
export default function FAQ() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 -z-10 h-96 w-96 rounded-full bg-blue-600/10 blur-[160px]" />
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 shadow-lg shadow-blue-600/30">
